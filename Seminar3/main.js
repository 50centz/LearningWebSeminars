...
// alert(`Резельтат сложения чисел ${num1} и ${num2} равно ${num1 + num2}`);




// Задача 3: Написать функцию, которая принимает имя пользователя при ее вызове и выводит сообщение с 
// приветствием пользователя по имени в консоль. 
...
// const u = confirm("Вам хорошо живёться ?");
// if (u) {
...
// alert(confirm("Вам хорошо живёться ?") ? "Тогда мы идём к вам": "Ну вы держитесь там!");
